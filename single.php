    ...
    <header class="post-header">
        <?php if ( has_post_thumbnail() ) : ?>
            <div class="post-cover">
                <?php the_post_thumbnail('airtime_cover'); ?>
            </div>
        <?php endif; ?>
        <div class="<?php wpbp_container_class(); ?>">
            <div class="<?php wpbp_option('main_class'); ?>">
                <h4 class="post-category"><?php echo airtime_post_main_category_name(); ?></h4>
                ...
                <aside id="sidebar" role="complementary">
                    ...
                    <?php if ( get_post_type() == 'post' ) : ?>
                        <div class="related-posts">
                            <h3 class="related-posts-title underline"><?php _e("Related Articles", 'airtime'); ?></h3>
